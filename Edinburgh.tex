...
\begin{center}
     \Large{\textbf{PRACE Workshop Cheat Sheet}} \\
\end{center}

\subsection{Course Material}
The slides, source code, traces and applications can be found on Archer:\\
\texttt{ /work/y14/shared}\\
The slides are also available online:\\
\texttt{ http://www.vi-hps.org/training/tws/tw16.html}\\

\subsection{Setup}
Add tools installation to module setup\\
\texttt{ \% module use /work/y14/shared/modules}\\
%\texttt{ \% module load UNITE}\\
Set up basic Score-P environment\\
\texttt{ \% module load scorep}
\subsubsection{Set up analysis tools}
CUBE profile viewer\\
...
\item Advanced instrumentation options available to further adjust the measurement configuration (ask the trainers!)
\end{itemize}
...
\texttt{ \% ssh -L30000:node123:300085 archer}\\[2ex]
